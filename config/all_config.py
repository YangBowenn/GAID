...
class AllConfig(Config):
    ...
    def parse_args(self):
        ...
        parser.add_argument('--audios_dir', type=str, default='data/MSRVTT_audio_features', help="Location of audios tensors")
        ...
        parser.add_argument('--clip_arch', type=str, default='ViT-B/32', choices=['ViT-B/32', 'ViT-B/16', 'ViT-L/14'], help="CLIP arch. only when not using huggingface")
        ...
        parser.add_argument('--world_size',  type=int, default=0, help='distributed training')
        parser.add_argument('--local-rank',  type=int, default=0, help='distributed training')
        parser.add_argument('--rank',  type=int, default=0, help='distributed training')
        parser.add_argument('--save_eval',  action="store_true", help='save eval results')
        parser.add_argument('--audio_encoder',  type=str, help='audio feature extactor')
        
        parser.set_defaults(save_eval=False)
