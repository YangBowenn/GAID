...
def sim_matrix_inference_stochastic(text_embeds_per_video_id, vid_embeds_pooled_per_video_id, pooling_type):
    ...
    """
    Input
        text_embeds_per_video_id: num_vids * num_text * max_text_per_vid * embed_dim
        vid_embeds_pooled_per_video_id: num_vids * num_vids * max_text_per_vid * embed_dim
    """
...
def sim_matrix_inference_stochastic_light_allops(text_embeds_per_video_id, vid_embeds_pooled_per_video_id, pooling_type,
    ...
    if pooling_type == 'avg':
        ...
        for batch in tqdm(range(0, batch_size, batch_size_split)):
        ...
        # delete both input matrix to save memory
...
def generate_embeds_per_video_id_stochastic(text_embeds_stochastic_allpairs, vid_embeds_pooled, all_vid_ids,
    ...
    if pooling_type == 'avg':
        ...
        text_embeds_per_video_id = torch.stack(text_embeds_per_video_id)  # [N_v, N_t, 1, D]
    ...
    if pooling_type == 'avg':
        ...
        # num_vids x num_vids x max_text_per_vid x embed_dim
        vid_embeds_pooled_per_video_id = torch.stack(vid_embeds_pooled_per_video_id) # [N_v, N_t, 1, D]
